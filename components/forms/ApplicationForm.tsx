      ...
      {status === 'success' ? (
        <div className="animate-[riseIn_0.5s_ease-out] rounded-3xl border-2 border-accent-500/40 bg-accent-50 p-10 text-center shadow-[0_8px_30px_-8px_rgba(0,0,0,0.15)]">
          ...
          <p className="mt-2 text-sm text-primary-950/85">
            Our team will review your application and reach out if there&apos;s
            a fit.
          </p>
        </div>
      ) : (
        <form
          ...
          className="grid grid-cols-1 gap-6 rounded-3xl border-2 border-primary-950/10 bg-white p-8 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.08)] transition-shadow duration-300 hover:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.12)] sm:p-10 md:grid-cols-2"
        >
          <Field
            label="Full name"
            name="name"
          ...
          <Field
            ...
            name="role"
            required
            placeholder="e.g. Courier Driver, Dispatcher..."
            error={fieldErrors.role}
            shake={shakeField === 'role'}
          />
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              required
              rows={5}
              placeholder="Relevant experience, availability, and why you'd be a good fit..."
          ...
          {status === 'error' && (
            <p className="rounded-xl bg-red-50 px-4 py-3 text-sm font-medium text-red-600 md:col-span-2">
              {errorMsg}
            </p>
          )}
